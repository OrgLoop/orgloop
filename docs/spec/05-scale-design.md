...
> For the full module design, see [Section 12: Modules (v1.1+)](#12-modules-v11).
...
export interface EventBus {
  ...
  unacked(since?: string): AsyncIterable<OrgLoopEvent>;
}
...
// Implementations:
// - FileCheckpointStore    → JSON file
// - SqliteCheckpointStore  → SQLite (for atomicity)
```
